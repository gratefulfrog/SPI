...
typeDict = { # key=type : value=[ngBytes, formatString]
    s_init_t    : [9,'<BIf'], # type 1011, 9 bytes struct,                  i.e. uint8_t,uint32_t,float
    s_bid_t     : [9,'<BIf'], # type 1011, 9 bytes struct,                  i.e. uint8_t,uint32_t,float
    s_payload_t : [9,'<BIf']} # type 1011, 9 bytes struct,                  i.e. uint8_t,uint32_t,float
