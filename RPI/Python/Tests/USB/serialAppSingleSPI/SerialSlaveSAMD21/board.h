...
class Board{
  protected:
    //uint8_t boardUSARTChannels[5]; //<! values for the USART chanels, i.e. channnel 0 is UART_1, etc.
  ...
  public:
     ...
     */
    Board(uint8_t numberADC, const uint8_t nbChannelVec[], const uint8_t SSVec[]);
    /** get the board id
